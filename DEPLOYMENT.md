...
════════════════════════════════════════════
  ✅ DASHBOARD DEPLOYED
  🌐 http://mlopsdash<short-sha>.<region>.azurecontainer.io:3000
  📡 API:     http://orderapi<short-sha>.<region>.azurecontainer.io:8000
════════════════════════════════════════════
```
...
- Dashboard: `http://mlopsdash<short-sha>.<region>.azurecontainer.io:3000`
